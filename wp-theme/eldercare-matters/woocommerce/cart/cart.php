<?php
/**
 * Cart Page — ECM theme override.
 *
 * Thumbnail and Quantity columns hidden; Remove button moved to right of Subtotal.
 *
 * Overrides: woocommerce/templates/cart/cart.php (v10.1.0)
 *
